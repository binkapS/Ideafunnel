    ...
    <div class="bg-white p-3 m-2 overflow-y-scroll h-fit">
        ...
        <form action="{{ route('article.create') }}" method="post" enctype="multipart/form-data" id="form">
            ...
            <div class="flex flex-col mb-2">
                ...
                <input type="text" name="topic" placeholder="Article topic" value="{{ old('topic') }}"
            ...
            <div class="flex flex-col mb-2">
                ...
                <input type="file" name="image" accept="image/jpg, image/png, image/jpeg" hidden class="hidden"
                    id="article-image">
                <div id="article-image-repre"
                    class="flex border-2 border-dashed border-gray-700 rounded-md px-2 py-5 justify-center items-center">
            ...
            <div class="flex flex-col mb-2">
                <select name="category"
                    class="p-2.5 bg-white outline-none border-2 border-gray-700 rounded-md font-semibold uppercase text-gray-400">
